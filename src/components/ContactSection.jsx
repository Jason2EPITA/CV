...
export default function ContactSection() {
  ...
  const handleSubmit = (e) => {
    ...
    emailjs
      .send(
        "service_sqijj26",     // ✅ Service ID
        "template_agsvpsn",    // ✅ Template ID
        {
          name: form.name,
          email: form.email,
  ...
  return (
    <div className="w-full max-w-3xl bg-white/90 backdrop-blur-xl rounded-3xl shadow-2xl ring-1 ring-slate-200 p-10">
